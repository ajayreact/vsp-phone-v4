...
const DEFAULT_TENANT_PERMISSIONS = [
  ...
  PERMISSIONS.TENANT_CONFERENCES_READ,
  PERMISSIONS.TENANT_CONFERENCES_WRITE,
  PERMISSIONS.TENANT_RECORDINGS_WRITE,
  PERMISSIONS.TENANT_RECORDING_POLICIES_READ,
  PERMISSIONS.TENANT_RECORDING_POLICIES_WRITE,
  PERMISSIONS.TENANT_CONTACTS_READ,
  PERMISSIONS.TENANT_CONTACTS_WRITE,
  PERMISSIONS.TENANT_RECEPTION_READ,
  PERMISSIONS.TENANT_RECEPTION_WRITE,
  PERMISSIONS.TENANT_BLF_READ,
  PERMISSIONS.TENANT_BLF_WRITE,
  PERMISSIONS.TENANT_PAGING_READ,
  PERMISSIONS.TENANT_PAGING_WRITE,
...
const ROLE_DEFINITIONS: Array<{ name: string; description: string; keys: string[] }> = [
  {
    name: 'Receptionist',
    description: 'Enterprise reception console — directory, BLF, park, pickup, and call control',
    keys: [
      PERMISSIONS.TENANT_RECEPTION_READ,
      PERMISSIONS.TENANT_RECEPTION_WRITE,
      PERMISSIONS.TENANT_CONTACTS_READ,
