export const queryKeys = {
  platform: {
    ...
    provisioningSettings: () => ['platform', 'provisioning', 'settings'] as const,
  ...
  tenant: {
    ...
    extensionHub: (search?: string, lifecycle?: string) =>
      ['tenant', 'extensionHub', search ?? '', lifecycle ?? 'active'] as const,
    extensionHubStats: (lifecycle?: string) => ['tenant', 'extensionHub', 'stats', lifecycle ?? 'active'] as const,
    extensionDetail: (id: string) => ['tenant', 'extensions', 'detail', id] as const,
    extensionActivity: (id: string) => ['tenant', 'extensions', 'activity', id] as const,
    sipCredentials: (lineId: string) => ['tenant', 'lines', 'sip-credentials', lineId] as const,
    ...
    search: (q: string, lifecycle?: string) => ['tenant', 'search', q, lifecycle ?? 'active'] as const,
    ...
    company: () => ['tenant', 'organization', 'company'] as const,
    sites: (search?: string) => ['tenant', 'organization', 'sites', search ?? ''] as const,
    departments: (search?: string) => ['tenant', 'organization', 'departments', search ?? ''] as const,
