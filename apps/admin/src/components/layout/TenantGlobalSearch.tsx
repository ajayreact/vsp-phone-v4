...
import { useTenantSearch } from '../../lib/hooks/queries/use-dids';
...
export function TenantGlobalSearch() {
  ...
  const { data: results = [], isFetching } = useTenantSearch(debounced, open && debounced.length >= 2);
  ...
  return (
    <div ref={containerRef} className="relative w-full max-w-xl">
      ...
      <Input
        ...
        placeholder="Search users, extensions, DIDs, devices…"
        value={query}
        onChange={(e) => {
